  ...
  return (
    <div className=" p-10 bg-base-200 text-base-content">
      <footer class="footer justify-between">
        ...
        <div className=" footer grid-cols-2 gap-32">
          <div>
        ...
        <div>
          <span class="footer-title no">Subscribe For Notification</span>
          <div class="form-control w-80">
            ...
            <div className="my-5">
              ...
              <div class="grid grid-flow-col my-4 gap-4">
                <a>
                  <svg
      ...
      <div className="footer footer-center">
        <p className="flex font-bold text-[16px]">
          Copyright &copy; 2022 - All right reserved by{" "}
          <a href="/" className="mx-[1px]  text-orange-500 ">
            Ed Tech Company
          </a>
        </p>
      </div>
